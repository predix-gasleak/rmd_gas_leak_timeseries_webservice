...
@Path("/gasleakservices")
public interface GasLeakDataApi
{
	/**
	 * @return -
	 */
	 ...
	 */
	@GET
	@Path("/onehour_data/sensor_id/{id}")
	public Response getLastHourWindDataPoints(@PathParam("id") String id,
			@HeaderParam(value = "Authorization") String authorization,
			@DefaultValue("1h-ago") @QueryParam("starttime") String starttime,
			@DefaultValue("25") @QueryParam("taglimit") String tagLimit,@DefaultValue("desc") @QueryParam("order") String tagorder);
	 ...
	 */
	@GET
	@Path("/latest_data_all")
	public Response getLatestWindDataPointsAll(@HeaderParam(value = "authorization") String authorization);
